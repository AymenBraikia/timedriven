...
export default function Sun({ classnames = "w-6", clr = "currentColor", style }: { classnames?: string; clr?: string; style?: React.CSSProperties }) {
    return (
        <svg fill={clr} style={style} className={classnames} version="1.1" id="XMLID_287_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <g>
