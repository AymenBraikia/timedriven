export default function Watch({ classnames = "w-6", clr = "currentColor", style }: { classnames?: string; clr?: string; style?: React.CSSProperties }) {
    return (
        <svg className={classnames} style={style} version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
                <path
                    fill={clr}
                    d="M334.139,244.409l-65.344-1.382L266.201,154c0-5.632-4.566-10.189-10.197-10.189
		...
		c6.359,0,11.514-5.164,11.514-11.522C345.653,249.556,340.499,244.409,334.139,244.409z"
                ...
                <path
                    fill={clr}
                    d="M417.22,174.168L374.395,70.452h-61.506v13.42c-17.906-5.946-36.983-9.284-56.884-9.284
		...
		C375.429,184.478,390.426,217.946,390.442,255.147z"
                ...
                <path
                    fill={clr}
                    d="M372.076,26.156C372.076,11.709,360.368,0,345.921,0H166.072c-14.448,0-26.164,11.709-26.164,26.156v24.596
		h232.168V26.156z"
                />
                <path
                    fill={clr}
                    d="M139.908,485.852c0,14.44,11.716,26.148,26.164,26.148h179.849c14.448,0,26.155-11.708,26.155-26.148v-24.596
		H139.908V485.852z"
                />
            </g>
        </svg>
