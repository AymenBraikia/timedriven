    ...
    return (
        <section className="flex-col flex-center w-dvw h-dvh fixed top-0 left-0 text-white">
            ...
            <div className="flex-center flex-col font-secondary fade-in">
                <h1 className="sm:title1 title3 tracking-widest">TIMEDRIVEN</h1>
                <h5 className="sm:title5 text-[18px]! tracking-wider">Your partner for high-end watches</h5>
                <Link aria-label="discover" className="underline sm:title6 text-[18px]" href={"#new"}>
                    Discover
                </Link>
            </div>
        </section>
