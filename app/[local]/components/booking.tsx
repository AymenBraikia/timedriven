...
export default async function Booking() {
    const t = await getTranslations("home.bookingBanner");
    return (
        <FadeInObserver>
            <div className={`w-full min-h-100 h-125 mt-12 sm:mt-20 relative flex-center flex-col text-center text-white select-none gap-4 px-4`}>
                <Image src="/book.webp" quality={60} alt="booking.webp" sizes="100vw" className="object-cover object-center select-none brightness-30" fill></Image>
