...
export default function Booking() {
    ...
    return (
        <FadeInObserver>
            <div className={`w-full min-h-100 h-125 mt-12 sm:mt-20 relative flex-center flex-col text-center text-white select-none font-secondary gap-4 px-4`}>
                ...
                <p className="z-10 sm:text-2xl text-xl tracking-wide leading-8 italic">{t("subtext")}</p>
                <Link aria-label={t("cta")} className="z-10 sm:text-3xl text-2xl underline italic" href={"/booking"}>
                    {t("cta")}
                </Link>
            </div>
        </FadeInObserver>
