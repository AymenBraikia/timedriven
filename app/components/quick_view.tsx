...
interface QuickViewProps {
	view: { price: number; src: string; name: string; id: number };
	onClose: () => void;
...
export default function QuickViewModal({ view, onClose, format }: QuickViewProps) {
	...
	return (
		<div tabIndex={0} role="banner" className="fixed left-0 top-0 w-dvw h-dvh bg-black/50 fade-in flex-center z-10" onClick={(e) => e.target === e.currentTarget && onClose()}>
