	...
	return (
		<FadeInObserver>
			<div className={`w-full h-125 my-20 relative flex-center flex-col text-center text-white select-none font-secondary gap-4`}>
				<Image src={booking_img} alt="booking.webp" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 33vw, 25vw" className="object-cover object-center select-none brightness-30" fill></Image>
